...
func Test_ExtractMPhone(t *testing.T) {
	//for valid phone num
	phone := "0.1521051028500172012156781212616271627126575700013567809811273正规发票13538046808薇同步发票,我的邮箱是13912345678@139.com我的电话是+8615210510288"
	...
	phoneNums := phoneRegx.FindAllStringSubmatch(phone, -1)
